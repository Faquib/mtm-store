...
const NewOrders = () => {
            ...
            const frontendCustomers = response.data.map(backendCustomer => {
                ...
                return {
                    ...
                    addresses: addresses.map(addr => ({
                        id: addr.address_id,
                        address_line1: addr.address_line || '',
                        locality: addr.locality || '',  // Add locality field
                        city: addr.city || '',
    ...
    const handleAddNewCustomer = async () => {
        if (!newCustomer.name || !newCustomer.phone || !newCustomer.email ||
            ...
            !newCustomer.addresses[0].locality ||  // Add locality validation
            !newCustomer.addresses[0].city ||
            !newCustomer.addresses[0].pincode ||
            !newCustomer.addresses[0].state_id) {
        ...
        try {
            ...
            const backendData = {
                ...
                address: {
                    ...
                    locality: newCustomer.addresses[0].locality,  // Separate locality field
                    address_line: newCustomer.addresses[0].address_line1,  // Just the address line
                        ...
                        <div className="customer-details">
                            ...
                            {selectedAddress && (
                                <>
                                    ...
                                    <div className="detail-row">
                                        <span className="detail-label">City/State/Pincode:</span>
                                        <span className="detail-value">
                                        ...
                                        <div className="new-customer-form">
                                            ...
                                            <div className="form-actions">
                                                ...
                                                <button
                                                    ...
                                                    disabled={!newCustomer.name || !newCustomer.phone || !newCustomer.email ||  // Email now required
                                                        !newCustomer.addresses[0].address_line1 ||
                                                        !newCustomer.addresses[0].city ||
                                                        !newCustomer.addresses[0].pincode}
                                                >
