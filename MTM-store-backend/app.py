...
app.config['GOOGLE_CLIENT_ID'] = os.environ.get('client_id')  # Replace with your Google Client ID
app.config['GOOGLE_CLIENT_SECRET'] = os.environ.get('client_secret') # Replace with your Google Client Secret


# Configure MySQL database
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://mtmadmin:mTmadmin%402012@localhost/n_mtm_store_db'
