...
const AllProducts = () => {
  ...
  const filteredProducts = React.useMemo(() => {
    return products
      ...
      .sort((a, b) => {
        // First sort by preference (lower numbers first, ignore 0)
        const aPref = a.preference || Number.MAX_SAFE_INTEGER;
        const bPref = b.preference || Number.MAX_SAFE_INTEGER;

        // If both have preferences, sort by preference
        if (aPref !== Number.MAX_SAFE_INTEGER || bPref !== Number.MAX_SAFE_INTEGER) {
          return aPref - bPref;
        }

        // If no preferences set, use the original sort logic
                    ...
                    >
                      ...
                      <div className="product-details">
                        ...
                        <div className="product-rating">
                          <div className="stars">
                            {[1, 2, 3, 4, 5].map((star) => (
                              <svg
                                ...
                                height="16"
                                viewBox="0 0 24 24"
                                fill={star <= Math.round(product.rating || 0) ? "#FFD700" : "#DDD"}
                                stroke="#FFD700"
                                strokeWidth="1"
                              >
                          ...
                          <span className="raters-count">({product.raters || 0})</span>
                        </div>
