...
const AddProducts = () => {
  ...
  const validationSchema = yup.object().shape({
    ...
    preference: yup.number().integer().min(0),
    models: yup.array()
      .of(
        yup.object().shape({
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    ...
    try {
      ...
      formData.append('preference', values.preference);  // Add this line
                ...
                <Form className="product-form" onSubmit={handleSubmitWithScroll}>
                  ...
                  <div className="form-section">
                    ...
                    <div className="form-grid">
                      ...
                      {/* ... other fields ... */}
                      <div className="form-group">
                        <label className="form-label">Display Preference</label>
                        <Field
                          type="number"
                          name="preference"
                          className="form-input"
                        ...
                        />
                        <small className="form-hint">Set display priority (Lower = shown first)</small>
                      </div>
